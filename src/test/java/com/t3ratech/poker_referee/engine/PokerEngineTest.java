...
public class PokerEngineTest {
    ...
    public void testEvaluateGames() {
        ...
        games.add("QD TS 7D AS AC 2C TD 6H 8H AH"); // P1 wins with 1 Pair
        games.add("6S AD 8C 4S 9H 8D 9D KH 8S 3C"); // P2 wins with 1 Pair
        games.add("QS 4D 2D 7S KH JS JC AD 4C 3C"); // P2 wins with 1 Pair
        ...
        Assert.assertEquals(results.get(1), 4);
        ...
        games.add("4C 7C 3C JC QS 9C KC AS 8D 3D"); //P2 wins with 13 points vs 12
        ...
        Assert.assertEquals(results.get(1), 3);
    }
